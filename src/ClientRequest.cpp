...
std::string ClientRequest::get_header(std::string key){
	//TO DO
}

std::string ClientRequest::get_body(std::string key){
	//TO DO
}
...
void ClientRequest::set_header(std::string key, std::string value){
	this->_Client_RequestMap_header[key] = value;
}
void ClientRequest::set_body(std::string key, std::string value){
	this->_Client_RequestMap_body[key] = value;
}
